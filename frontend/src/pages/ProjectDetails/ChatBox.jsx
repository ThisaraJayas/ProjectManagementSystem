    ...
    <div className='sticky'>
      <div className='border rounded-lg'>
        ...
        <ScrollArea className="h-[32rem] w-full p-5 flex gap-3 flex-col">
          {[1,1,1,1].map((item,index)=>(index%2==0?<div key={item} className='flex gap-2 mb-2 justify-start'>
            <Avatar>
        ...
        <div className='relative p-0 '>
          ...
          className="py-7 border-t outline-none focus:outline-none focus:ring-0 rounded-none vorder-b-0 border-x-0"/>
